...
<form id="ahuform">
	...
	<div style="float: right; margin-right: 164px; margin-top:10px; margin-bottom: 60px"><input id="save_ahu" class="btn btn-primary btn-lg main_button" style="width: 122px" type="submit" value="Save copy"/></div>
</form>
...
<script type="text/javascript">
	...
	function fillahuerrors(data) {
		...
		if (supplysyserror != null) {
			$('#supplysystemnameer').append(supplysyserror);
		}
		var exhaustsyserror = data.exhaustsystemname;
		if (exhaustsyserror != null) {
			$('#supplysystemnameer').append(exhaustsyserror);
		}
