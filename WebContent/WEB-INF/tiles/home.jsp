...
$(document).ready(function(){
	...
	$('#sortContainer_top_left').append('<img id="valve_top" class="ui-draggable ui-draggable-handle ui-draggable-dragging sortable ui-state-error top_left_elem" src="/Air/static/img/valve.jpg" title="valve" style="position: relative;" uniqelemname="valve_top4">') ;
	$('#sortContainer_top_left').append('<img id="filter_top" class="ui-draggable ui-draggable-handle ui-draggable-dragging sortable ui-state-error top_left_elem" src="/Air/static/img/filter.jpg" title="filter" style="position: relative;" uniqelemname="filter_top3">') ;
	$('#sortContainer_top_left').append('<img id="plate_recuperator_top" class="ui-draggable ui-draggable-handle ui-draggable-dragging sortable ui-state-error top_left_elem" src="/Air/static/img/recuperator_top.jpg" title="plate recuperator" style="position: relative;" uniqelemname="plate_recuperator_top1">') ;

	$('#sortContainer_top_right').append('<img id="fan_left_top" class="ui-draggable ui-draggable-handle ui-draggable-dragging sortable ui-state-error top_right_elem" src="/Air/static/img/fan2.jpg" title="fan" style="position: relative; left: 0px; top: 0px;" uniqelemname="fan_left_top7">') ;
	$('#sortContainer_top_right').append('<img id="filter_top" class="ui-draggable ui-draggable-handle ui-draggable-dragging sortable ui-state-error top_right_elem" src="/Air/static/img/filter.jpg" title="filter" style="position: relative; left: 0px; top: 0px;" uniqelemname="filter_top8">') ;

	$('#sortContainer_bottom_left').append('<img id="valve_top" class="ui-draggable ui-draggable-handle ui-draggable-dragging sortable ui-state-error bottom_left_elem" src="/Air/static/img/valve.jpg" title="valve" style="position: relative; left: 0px; top: 0px;" uniqelemname="valve_top6">') ;
	$('#sortContainer_bottom_left').append('<img id="empty_section_small_bot" class="ui-draggable ui-draggable-handle ui-draggable-dragging sortable ui-state-error bottom_left_elem" src="/Air/static/img/empty_small.jpg" title="empty section" style="position: relative;" uniqelemname="empty_section_small_bot5">') ;
	$('#sortContainer_bottom_left').append('<img id="plate_recuperator_bot" class="ui-draggable ui-draggable-handle ui-draggable-dragging sortable ui-state-error bottom_left_elem" src="/Air/static/img/recuperator_bottom.jpg" title="plate recuperator" style="position: relative;" uniqelemname="plate_recuperator_bot2">') ;

	$('#sortContainer_bottom_right').append('<img id="water_heater_bot" class="ui-draggable ui-draggable-handle ui-draggable-dragging sortable ui-state-error bottom_right_elem" src="/Air/static/img/heater_water.jpg" title="water heater" style="position: relative;" uniqelemname="water_heater_bot9">') ;
	$('#sortContainer_bottom_right').append('<img id="fan_right_top" class="ui-draggable ui-draggable-handle ui-draggable-dragging sortable ui-state-error bottom_right_elem" src="/Air/static/img/fan1.jpg" title="fan" style="position: relative; left: 0px; top: 0px;" uniqelemname="fan_right_top10">') ;
